...
import '../service/api_service_impl.dart';

final postRepositoryProvider = Provider<PostRepository>((ref) => PostRepositoryImpl(ref.read));
...
class PostRepositoryImpl implements PostRepository {
  ...
  Future<List<QiitaPost>> fetch({
    ...
    return (await _api.getItems(page: page, perPage: perPage, query: query)).maybeWhen(
