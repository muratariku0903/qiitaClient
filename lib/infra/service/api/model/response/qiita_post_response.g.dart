...
_$_QiitaPostResponse _$$_QiitaPostResponseFromJson(Map<String, dynamic> json) =>
    _$_QiitaPostResponse(
      ...
      likesCnt: json['likes_count'] as int,
      tags: (json['tags'] as List<dynamic>)
          .map((e) => QiitaTagJson.fromJson(e as Map<String, dynamic>))
          .toList(),
      title: json['title'] as String,
      url: json['url'] as String,
      user: QiitaUserJson.fromJson(json['user'] as Map<String, dynamic>),
    );
